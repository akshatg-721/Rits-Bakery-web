...
export default function MenuPage() {
  ...
  return (
    <main className="min-h-screen bg-[#FAFAF8]">
      {/* ── Hero banner ── */}
      <section className="relative overflow-hidden bg-[#111111] px-4 py-20 text-center sm:py-28">
        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          <h1 className="mt-4 font-serif text-4xl italic text-white sm:text-6xl">
            Our Menu
          </h1>
          <p className="mx-auto mt-5 max-w-lg text-sm leading-relaxed text-white/50 sm:text-base">
            Every creation is baked fresh to order — eggless, premium, and made
            with intention. Pre-order 24 hours in advance.
          </p>
          ...
          <div className="relative mx-auto mt-10 max-w-md">
            ...
            <input
              ...
              className="h-12 w-full rounded-full border border-white/10 bg-white/5 pl-11 pr-5 text-sm text-white placeholder:text-white/30 backdrop-blur transition-colors duration-200 focus:border-white/25 focus:bg-white/10 focus:outline-none"
            />
          </div>
        </div>
      </section>
        ...
        {filteredCategories.length === 0 && (
          <div className="py-24 text-center">
            ...
            <button
              ...
              className="mt-3 text-sm font-medium text-[#006241] underline underline-offset-4 transition hover:text-[#004F35]"
            >
              Clear search
            </button>
          </div>
